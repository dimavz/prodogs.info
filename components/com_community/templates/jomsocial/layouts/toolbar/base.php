    ...
    <ul>
        ...
        <li class="joms-js--notification-chat-list-mobile">
            ...
            <ul class="joms-popover joms-arrow--top joms-popover--toolbar-chat" data-propagate="1">
                ...
                <a class="joms-button--neutral joms-button--full" href="<?php echo CRoute::_('index.php?option=com_community&view=chat'); ?>" style="display:none"><?php echo JText::_('COM_COMMUNITY_CHAT_NOTIF_SHOW_ALL') ?></a>
            </ul>
        </li>
        <?php } ?>
