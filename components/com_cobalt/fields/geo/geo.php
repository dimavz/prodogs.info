...
class JFormFieldCGeo extends CFormField
{
	...
	public function getInput()
	{
		if(in_array($this->params->get('params.map_marker'), $this->user->getAuthorisedViewLevels()))
		{
			...
			JFactory::getDocument()->addScript(JUri::root(TRUE) . '/components/com_cobalt/fields/geo/assets/geo.js?1=5');
		}
	...
	{
		$icon_url = '/components/com_cobalt/fields/geo/markers/grouped/other/marker-big-red.png';
