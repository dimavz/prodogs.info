...
class JFormFieldCAkimage extends CFormField
{
	...
	public function validate($value, $record, $type, $section)
	{
		...
		if($check && FALSE === array_search(strtolower($ext), array('jpg', 'jpeg', 'png', 'gif')))
		{
			$this->setError(JText::sprintf('F_NOTALLOWEDEXT', $this->label));
