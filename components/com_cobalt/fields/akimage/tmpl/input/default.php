...
<?php if($this->params->get('params.allow_custom_url')): ?>
	<div class="form-inline">
		<label for="image_customurl<?php echo $this->id;?>"><?php echo JText::_('CUSTOMURL');?>:</label>
		<input id="image_customurl<?php echo $this->id;?>" type="text"  style="width:230px;" name="jform[fields][<?php echo $this->id;?>][image_customurl]"
		value="<?php echo (isset($this->value['image_customurl']) ? stripslashes($this->value['image_customurl']) : '');?>" class="inputbox"/>
	</div>
<?php endif; ?>
