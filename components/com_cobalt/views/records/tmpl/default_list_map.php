...
{
	JFactory::getDocument()->addScript('components/com_cobalt/fields/geo/assets/markerclusterer.min.js');
}
...
(function($) {
	...
	$.ajax({
		...
		markerCluster = new MarkerClusterer(map, markers, {
			...
			imagePath: '<?php echo JUri::root(TRUE) ?>/components/com_cobalt/fields/geo/assets/m/',
			maxZoom: 15
		});
