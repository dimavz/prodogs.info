	...
	<div class="es-reaction-stats-pop">
		...
		<div class="es-reaction-stats-pop__hd">
			<div class="es-reaction-icon-stat">
				...
				<a href="#<?php echo $reaction->getKey();?>" class="es-reaction-icon-stat__item <?php echo $i == 0 ? 'is-active' : '';?>" data-bs-toggle="tab">
		...
		<div class="es-reaction-stats-pop__bd">
			<div class="tab-content">
				<?php $i = 0; ?>
				<?php foreach ($reactions as $reaction) { ?>
				<div class="tab-pane <?php echo $i == 0 ? 'active' : '';?>" id="<?php echo $reaction->getKey();?>">
						<div class="es-reaction-stats-list">
							<?php foreach ($reaction->users as $user) { ?>
							<div class="es-reaction-stats-list__item">
								<div class="o-media">
									<div class="o-media__image">
										<?php echo $this->html('avatar.user', $user, 'sm', false); ?>	
									</div>
