			...
			<form action="<?php echo JRoute::_('index.php');?>" method="post" enctype="multipart/form-data" class="es-forms" data-videos-form>
					...
					<div class="es-forms__content">
						<div class="o-form-horizontal">
							...
							<div class="o-form-group">
								<?php if (!$isCluster && $this->config->get('privacy.enabled')) { ?>
									<div class="es-privacy-cf">
										<?php echo $privacy->form($video->id, SOCIAL_TYPE_VIDEOS, $this->my->id, 'videos.view', true, null, array(), array('linkStyle' => 'button', 'iconOnly' => false)); ?>
									</div>
								<?php } ?>
								<?php echo $this->html('form.label', 'COM_EASYSOCIAL_VIDEOS_VIDEO_TITLE', 3, false); ?>

								<div class="o-control-input">
									<?php echo $this->html('grid.inputbox', 'title', $this->html('string.escape', $video->title), 'video-title', array('data-video-title placeholder="' . JText::_('COM_EASYSOCIAL_VIDEOS_VIDEO_TITLE_PLACEHOLDER') . '"')); ?>
								</div>
							</div>
							...
							<div class="o-form-group">
								...
								<div class="o-control-input">  
									<?php echo $this->html('grid.textarea', 'description', $this->html('string.escape', $video->description), 'video-desc', array('placeholder="' . JText::_('COM_EASYSOCIAL_VIDEOS_VIDEO_DESCRIPTION_PLACEHOLDER') . '"')); ?>
								</div>
							</div>
				...
				<div class="es-forms__actions">
					<div class="o-form-actions">
						...
						<button class="btn btn-es-primary-o t-pull-right" data-save-button>
