					...
					<div class="es-forms__content">
						<div class="o-form-horizontal">
							...
							<div class="o-form-group">
								...
								<?php if (!$isCluster && $this->config->get('privacy.enabled')) { ?>
									<div class="es-privacy-cf">
										<?php echo $privacy->form($audio->id, SOCIAL_TYPE_AUDIOS, $this->my->id, 'audios.view', true, null, array(), array('linkStyle' => 'button', 'iconOnly' => false)); ?>
									</div>
								<?php } ?>
								...
								<div class="o-control-input">
									<?php echo $this->html('grid.inputbox', 'title', $this->html('string.escape', $audio->title), 'audio-title', array('placeholder="' . JText::_('COM_ES_AUDIO_FORM_TITLE_PLACEHOLDER') . '" data-audio-title')); ?>
								</div>
							</div>
							...
							<div class="o-form-group">
								...
								<div class="o-control-input">
									<?php echo $this->html('grid.inputbox', 'artist', $this->html('string.escape', $audio->artist), 'audio-artist', array('placeholder="' . JText::_('COM_ES_AUDIO_FORM_ARTIST_PLACEHOLDER') . '" data-audio-artist')); ?>
								</div>
							</div>
							...
							<div class="o-form-group">
								...
								<div class="o-control-input">
									<?php echo $this->html('grid.inputbox', 'album', $this->html('string.escape', $audio->album), 'audio-album', array('placeholder="' . JText::_('COM_ES_AUDIO_FORM_ALBUM_PLACEHOLDER') . '" data-audio-album')); ?>
								</div>
							</div>
