	...
	<div class="o-media o-media--top">
		...
		<div class="o-media__body">
			<div data-comment-wrapper>
				...
				<div class="es-comment-actions" data-comment-actions>
					<div class="dropdown_">
						...
						<ul class="dropdown-menu dropdown-menu-right">
							...
							<li>
								<?php echo ES::reports()->getForm('com_easysocial', 'comments', $comment->id, JText::sprintf('COM_EASYSOCIAL_COMMENTS_REPORT_ITEM_TITLE' , $author->getName()), JText::_( 'COM_EASYSOCIAL_COMMENTS_REPORT_ITEM' ), '' , JText::_( 'COM_EASYSOCIAL_COMMENTS_REPORT_TEXT' ) , FRoute::external($comment->getPermalink())); ?>
							</li>
							<?php } ?>
				...
				<ul class="es-comment-attachments fd-cf<?php echo count($attachments) > 1 ? ' is-multiple' : ''; ?>">
