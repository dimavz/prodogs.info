...
?>
<div class="es-container" data-discussion-item data-uid="<?php echo $cluster->id;?>" data-type="<?php echo $cluster->getType();?>" data-id="<?php echo $discussion->id;?>">
								...
								<div class="es-apps-entry__meta">
									<div class="es-apps-entry__meta-item">
										<ol class="g-list-inline g-list-inline--dashed">
											...
											<li>
												<i class="fa fa-clock-o"></i>&nbsp; <?php echo ES::date($discussion->created)->format(JText::_('DATE_FORMAT_LC1'));?>
											</li>
