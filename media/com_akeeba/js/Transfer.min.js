...
akeeba.Transfer.uploadArchive=function(a){void 0===a&&(a=0);var b=document.getElementById("akeeba-transfer-upload-lbl-kickstart"),c=document.getElementById("akeeba-transfer-upload-lbl-archive"),e=document.getElementById("akeeba-transfer-upload-error");e.style.display="none";b.className="akeeba-label--green";c.className="akeeba-label--orange";akeeba.System.doAjax({task:"upload",start:a},function(a){if(a.result)if(a.done){document.getElementById("akeeba-transfer-upload-percent").textContent="100 %";
document.getElementById("akeeba-transfer-upload-size").innerHTML="";document.getElementById("akeeba-transfer-upload-area-kickstart").style.display="block";document.getElementById("akeeba-transfer-upload-area-upload").style.display="none";var b=document.getElementById("akeeba-transfer-url").value.replace(/\/$/,"")+"/kickstart.php";document.getElementById("akeeba-transfer-upload-btn-kickstart").setAttribute("href",b)}else{var b=0,d=1*a.totalSize;a=1*a.doneSize;0<d&&0<a&&(b=a/d*100);document.getElementById("akeeba-transfer-upload-percent").textContent=
b.toFixed(2)+"%";document.getElementById("akeeba-transfer-upload-size").textContent=a.toFixed(0)+" / "+d.toFixed(0)+" bytes";window.setTimeout(function(){akeeba.Transfer.uploadArchive(0)},50)}else c.className="akeeba-label--red",e.innerHTML=a.message,e.style.display="block"},null,!1,15E4)};
