...
<li class="data-field-multidropdown-item" data-field-multidropdown-item>
	<div class="o-grid">
		...
		<div class="o-grid__cell">
			<select name="<?php echo $inputName; ?>[]" class="o-form-control" data-field-multidropdown-input>
				<?php foreach ($choices as $id => $choice) { ?>
				<option value="<?php echo $choice->value; ?>" <?php echo $value && $value === $choice->value || !$value && $choice->default ? 'selected="selected"' : '';?>>
