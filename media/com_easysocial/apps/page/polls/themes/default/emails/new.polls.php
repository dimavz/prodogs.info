		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_PAGE_NEW_POLLS', $page); ?></h1>
				</td>
			</tr>
		</table>
	</td>
									...
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										<tr>
											<td style="padding: 5px 0;">
												...
												<?php echo JText::sprintf('COM_ES_EMAILS_PAGE_NEW_POLLS_CONTENT', '<a href="' . $pageLink . '" style="color:#00aeef; text-decoration:underline;">' . $page . '</a>');?>
										...
										<tr>
											<td style="padding: 5px 0;">
												<?php echo JText::_('COM_EASYSOCIAL_EMAILS_POSTED_BY');?>: <a href="<?php echo $pageLink;?>" style="color:#00aeef; text-decoration:underline;"><?php echo $page;?></a>
											</td>
										</tr>
										<tr>
											<td style="padding: 5px 0;">
