...
if(!c.block||c.br)return null;if(!c.trigger){var d=c.text.nodeValue,e=d.slice(0,1),f=b.getTrigger(e);if(!f)return null;c.trigger=f,c.value=d.slice(1)}var g=c.start,h=b._textarea.value,i=h.match(/^\n+/g);if(null!=i){var j=i[0].split(/\r*\n/),k=j.length-1;if(k>0)var g=c.start-k}var l={start:g,length:c.length,type:c.trigger.type,value:c.value};return a?JSON.stringify(l):l});return c?d:d.reverse()},insert:function(a,c,d){var e,f;if(c===d||void 0===d)e=b.getMarkerAt(c),f=e.start,e.insert(a,c-f,d-f);else{var g=b.getMarkersBetween(c,d),h=g.length;
if(1>h)return;if(1==h)e=g[0],f=e.start,e.insert(a,c-f,d-f);else{var i=h-1,e=g[i];for(e.block&&d>e.start&&e.toTextMarker(),d-e.start>0&&e.insert("",0,d-e.start);(e=g[--i])&&i>0;)e.remove();e.block&&0===e.index&&0===c&&e.toTextMarker(),e.insert(a,c-e.start,e.length),0===c&&e.br&&e.remove()}}return b.normalize(),e},textareaInsert:function(a,c,d){var e=b._textarea,f=e.value;return e.value=f.substring(0,c)+a+f.slice(d)},normalize:function(){var a=b._overlay,c=b._textarea;a.normalize();var d=a.firstChild,e=a.lastChild,f=document.createTextNode("");
e&&"BR"!==e.nodeName||a.appendChild(f),e&&e==d&&1===e.nodeType&&e.hasAttribute("data-ignore")&&a.insertBefore(f,e),a.style.height="auto",a.style.height=c.scrollHeight+"px",c.scrollTop=0,b.lengthBefore=c.value.length},lengthBefore:0,caretBefore:{start:0,end:0},caretAfter:{start:0,end:0},skipKeydown:!1,previousMarker:null,initialFocus:!0,isPasting:!1,tagToProcess:[],"{textarea} focus":function(){b.initialFocus&&b.textarea().caret(b.initialCaret||0)},"{textarea} keydown":function(c,d){if(b.initialFocus=!1,!b.skipKeydown){{b.caretBefore=c.caret()
}8===d.keyCode&&a.IE<10&&b.overlay().css("opacity",0),b.skipKeydown=!0}},"{textarea} keypress":function(a,c){b.caretBefore=a.caret(),8===c.keyCode},convertHashTag:function(){var d=b.overlay().html();d=d.replace(/<span[^>]*>(#.*?)<\/span[^>]*>/g,"$1"),d=d.replace(/<br\s*[\/]?>/gi,"\n");var e=d.match(/#[^\s]+[\w]/g);if(e&&e.length>0){var f=[];a.each(e,function(b,c){-1==a.inArray(c,f)&&f.push(c)}),a(f).each(function(a,b){var c=b.replace("#",""),e=c.match(/[&=\?]/g);if(!e){spanEle="<span>$1</span>";var f=new RegExp("("+b+")($|^|\\b)","gm");
d=d.replace(f,spanEle)}}),b.overlay().html(d)}},"{textarea} input":function(a){b.reflect(),b.isPasting&&(b.convertHashTag(),b.isPasting=!1),a.val().length<1&&b.reset()},"{textarea} paste":function(){b.isPasting=!0},"{textarea} keyup":function(c,d){if(b.skipKeydown=!1,8===d.keyCode&&a.IE<10){var e=b.caretBefore,f=b.caretAfter=b.textarea().caret();b.insert("",f.end,e.end),b.caretBefore=f,b.overlay().css("opacity",1)}b.isPasting&&(b.isPasting=!1)},reflect:function(){var c=b._textarea,d=c.value,e=b.caretBefore,f=b.caretAfter=a(c).caret(),g=a.browser.opera&&f.end>f.start,h=b.getMarkerAt(e.start),i=b.lengthBefore-d.length,j=!1;
...
},trigger:function(a,b){this.tooltip.trigger(a,b),this.button.trigger(a,b)},show:function(){var c=this;if(c.enabled=!0,!c.wait){if(clearTimeout(c.hideTimer),c.exclusive&&a("[data-popbox-tooltip]").each(function(){var c=b.get(a(this));c&&c.hide(!0)}),c.button.addClass("active"),"click"==c.toggle){var d=a(document),e=b.toggleEvent+".popbox."+c.uid;d.off(e).on(e,function(b){var f=a(b.target).parents().andSelf();f.filter(c.button).length>0||f.filter(c.tooltip).length>0||(d.off(e),c.hide())})}var f=a(window),g="resize.popbox"+c.uid;
...
}}}}),b.resolve()}),EasySocial.module("apps/fields/event/recurring/content",function(a){var b=this,c=EasySocial.options.momentLang;EasySocial.require().library("datetimepicker","moment/"+c).done(function(){EasySocial.Controller("Field.Event.Recurring",{defaultOptions:{dateFormat:"",id:null,value:{},allday:0,showWarningMessages:0,eventId:null,"{type}":"[data-recurring-type]","{endBlock}":"[data-recurring-end-block]","{picker}":"[data-recurring-end-picker]","{toggle}":"[data-recurring-end-toggle]","{result}":"[data-recurring-end-result]","{dailyBlock}":"[data-recurring-daily-block]","{dailyInput}":"[data-recurring-daily-block] input","{summaryBlock}":"[data-recurring-summary-block]","{showSchedules}":"[data-show-schedules]","{scheduleLoadingBlock}":"[data-recurring-schedule-loading-block]","{deleteRecurringButton}":"[data-recurring-delete]"}},function(b){return{init:function(){var d=b.options.dateFormat;
b.picker()._datetimepicker({pickTime:!1,component:"es",useCurrent:!1,format:d,language:c});var e=b.result().val();if(!a.isEmpty(e)){var f=a.moment(e);b.datetimepicker("setDate",f)}b.calculateRecurringEvents()},changed:0,"{window} easysocial.fields.allday.change":function(a,c,d){b.options.allday=d,b.calculateRecurringEvents()},"{window} easysocial.fields.startend.start.change":function(){b.calculateRecurringEvents()},"{toggle} click":function(){b.picker().focus()},"{picker} dp.change":function(a,c){b.setDateValue(c.date.toDate()),b.detectChanges(),b.calculateRecurringEvents()
...
},"{suggestion} mouseover":function(a){b.suggestion().removeClass("active"),a.addClass("active").trigger("activate")},"{suggestion} click":function(a){var d=a.data("location");b.set(d),b.hideSuggestions(),b.validateInput()},set:function(a){b.currentLocation=a;var c=a.geometry.location.lat(),d=a.geometry.location.lng();b.navigate(c,d);var e=a.formatted_address;b.textField().val(e),b.lastQueryAddress=e,b.base().addClass("has-location"),b.result=a;var f=b.getResult("source");b.source().val(JSON.stringify(f))},unset:function(){b.currentLocation=null,b.textField().val(""),b.mapImage().attr("src",""),b.base().removeClass("has-location"),b.source().val("")
...
}},always:function(){clearTimeout(b.detectTimer),b.base().removeClass("is-busy")}})},raiseError:function(a){b.trigger("error",[a])},clearError:function(){b.trigger("clear")},validateInput:function(){if(b.clearError(),a.isEmpty(b.source().val())&&d.required)return b.raiseError(d.error.maps),!1;var c=JSON.parse(b.source().val());return c.latitude&&c.longitude||!d.required?!0:(b.raiseError(d.error.maps),!1)},"{self} onSubmit":function(a,c,d){d.push(b.validateInput())},"{removeButton} click":function(){b.unset(),b.hideSuggestions(),b.validateInput()
...
c.on("change",function(){b.fieldChanged(a)}),c.on("keyup",function(){b.fieldChanged(a)}),c.on("onFieldHide",function(){b.hideSelf(a)}),c.on("onFieldShow",function(){b.fieldChanged(a)}),c.hasClass("t-hidden")||b.fieldChanged(a)},getRequiredChecking:function(){var b=a("[data-conditional-check]").val();return b?JSON.parse(b):!1},fieldChanged:function(d){var e=b.getTargetedFieldValue(d);if(c.result[d]=b.checkCondition(e,d),c.result){var f=!0;a.each(c.result,function(a,b){0==b&&(f=!1)}),f?b.showSelf():b.hideSelf()
}},checkCondition:function(a,d){var e=c.conditionValue[d],f=!1;switch(a=b.formatValue(a,d),c.operator[d]){case"equal":a==e&&(f=!0);break;case"not equal":a!=e&&(f=!0);break;case"contain":f=new RegExp("\\b"+e+"\\b","i").test(a)}return f},getTargetedFieldValue:function(c){var d=b.getTargetedField(c),f=(b.getTargetedFieldElement(c),d.find(":input")),g=[],h=!1;return f.length>0&&a.each(f,function(){var b=a(this),c=b.attr("type");if("hidden"!=c)switch(c){case"radio":radio=b.is(":checked")?1:0,radio&&(g=b.val());break;
case"checkbox":checkbox=b.is(":checked"),checkbox&&g.push(b.val());break;case"button":var d=b.parent(),e=d.find("input");"hidden"==e.attr("type")&&(g=e.val());break;default:b.val()&&(g=b.val())}}),a.isArray(g)?a.each(g,function(a,b){h=h?h+" "+b:b}):h=g,h},showSelf:function(){d.removeClass("t-hidden"),d.trigger("onFieldShow"),b.updateRequiredChecking(!0)},hideSelf:function(){d.addClass("t-hidden"),d.trigger("onFieldHide"),b.updateRequiredChecking(!1)},updateRequiredChecking:function(d){var e=b.getRequiredChecking();
e&&(e[c.id]=d,e=JSON.stringify(e),a("[data-conditional-check]").val(e))},getTargetedField:function(b){var d=a('[data-field-item][data-id="'+c.fieldTargeted[b]+'"]');return d},getTargetedFieldElement:function(a){var c=b.getTargetedField(a);return c.data("fieldItem")},formatValue:function(a,c){var d=b.getTargetedFieldElement(c);return"gender"==d&&a&&(a="1"==a?"male":"3"==a?"other":"female"),a},formatConditionsValue:function(a){{var d=b.getTargetedFieldElement(a);c.conditionValue[a]}"gender"==d&&("1"==c.conditionValue[a]&&(c.conditionValue[a]="male"),"2"==c.conditionValue[a]&&(c.conditionValue[a]="female"),"3"==c.conditionValue[a]&&(c.conditionValue[a]="other"))
...
},removeItem:function(c){var d=a("#"+c),e=a(d).find("input[name=upload-id\\[\\]]").val();return d.remove(),e?(EasySocial.ajax("site/controllers/uploader/delete",{id:e}).done(function(){b.options.plupload.removeFile(b.options.plupload.getFile(c))}),void 0):(b.options.plupload.removeFile(b.options.plupload.getFile(c)),void 0)},startUpload:function(){b.upload()},upload:function(){b.options.plupload.files.length>0&&(b.options.uploading=!0,b.options.plupload.start())},hasFiles:function(){return b.options.files.length>0
},"{uploaderForm} FilesAdded":function(a,d,e,f){b.createFileItem(f),c.temporaryUpload&&b.startUpload()},"{uploaderForm} UploadProgress":function(a,c,d,e){e&&b.queueItem("#"+e.id).trigger("UploadProgress",e)},"{uploaderForm} FileUploaded":function(a,c,d,e,f){b.queueItem("#"+e.id).trigger("FileUploaded",[e,f])},"{uploaderForm} UploadComplete":function(){b.options.uploading=!1},"{uploaderForm} Error":function(a,c,d,e){b.clearMessage();var f={message:e.message,type:"error"};b.setMessage(f)},"{uploaderForm} FileError":function(a,c,d,e,f){var g={message:f.message,type:"error"};
b.setMessage(g),b.queueItem("#"+e.id).trigger("FileError",[e,f])}}}),b.resolve()})}),EasySocial.require().script("admin/api/tabs","admin/vendors/uniform","admin/grid/grid","shared/responsive","shared/elements","shared/popdown","shared/privacy").library("dialog","select2").done(function(a){a(".uniform, input:file[data-uniform], .usergroups :checkbox").uniform(),a("[data-es-app-side-toogle]").on("click",function(){a("[data-es-app]").toggleClass("is-sidebar-close")}),a("[data-sidebar-menu-toggle]").on("click",function(){var b=a(this).parent("li"),c=b.find("ul"),d=a(this).parent("li").hasClass("active");
d?(b.removeClass("active"),c.removeClass("in")):(b.addClass("active"),c.addClass("in"))}),a("[data-table-grid-filter]").select2({theme:"backend",width:"resolve",minimumResultsForSearch:1/0}),a("[data-table-grid-filter]").on("select2:open",function(){a("body").addClass("has-select2-dropdown")}),a("[data-table-grid-filter]").on("select2:close",function(){a("body").removeClass("has-select2-dropdown")}),EasySocial.compareVersion=function(a,b){for(var c=0,d=a.split("."),e=b.split("."),f=Math.max(d.length,e.length),g=0;f>g;g++){var h=g<d.length?parseInt(d[g],10):0,i=g<e.length?parseInt(e[g],10):0;
if(isNaN(h)&&(h=0),isNaN(i)&&(i=0),h!=i){c=h>i?1:-1;break}}return c};var b=a("[data-table-grid]");b.length>0&&b.implement(EasySocial.Controller.Grid)}),EasySocial.module("admin/api/tabs",function(a){var b=this;a(document).on("click.tabs.active","[data-es-form-tabs] [data-item]",function(){var b=a("[data-tab-active]");if(!(b.length<=0)){var c=a(this).data("item");b.val(c)}}),b.resolve()}),EasySocial.module("admin/api/toolbar",function(a){var b=this,c=a("#toolbar"),d=a("[data-toolbar-actions]");d.length>0&&d.each(function(){var b=a(this),d=b.data("position")||"append";
b.removeClass("t-hidden"),"append"==d?b.appendTo(c):b.prependTo(c),b.find("[data-action]").each(function(){var b=a(this),c=b.data("action");b.on("click",function(){Joomla.submitbutton(c)})})}),b.resolve()}),EasySocial.module("admin/apps/store",function(){var b=this;EasySocial.Controller("Apps.Store",{defaultOptions:{"{item}":"[data-app-item]","{install}":"[data-app-install]"}},function(a){return{init:function(){},getItem:function(b){return b.closest(a.item.selector)},"{install} click":function(b){{var d=a.getItem(b);
1==b.data("payment"),"external"==b.data("app-install")}EasySocial.dialog({content:EasySocial.ajax("admin/views/store/confirmation",{id:d.data("id")})})}}}),b.resolve()}),EasySocial.module("admin/clusters/users",function(a){var b=this;EasySocial.Controller("Clusters.Users",{defaultOptions:{clusterid:null,clustertype:"","{addMember}":"[data-cluster-add-member]","{removeMember}":"[data-cluster-remove-member]","{approveMember}":"[data-cluster-approve-member]","{promoteMember}":"[data-cluster-promote-member]","{demoteMember}":"[data-cluster-demote-member]"}},function(b,c){return{"{addMember} click":function(){var e={};
window.addMembers=function(a){a.state?e[a.id]=a:delete e[a.id]},EasySocial.dialog({content:EasySocial.ajax("admin/views/"+c.clustertype+"/addMembers"),bindings:{"{submitButton} click":function(){var b=a("[data-form-add-members]"),c=b.find("[data-ids]"),d=[];a.each(e,function(a,b){d.push(b.id)}),c.val(JSON.stringify(d)),a("[data-form-add-members]").submit()}}})},"{removeMember} click":function(){0==document.adminForm.boxchecked.value?alert(c.error.empty):a.Joomla("submitform",["removeMembers"])},"{approveMember} click":function(){0==document.adminForm.boxchecked.value?alert(c.error.empty):a.Joomla("submitform",["publishUser"])
},"{promoteMember} click":function(){0==document.adminForm.boxchecked.value?alert(c.error.empty):a.Joomla("submitform",["promoteMembers"])},"{demoteMember} click":function(){0==document.adminForm.boxchecked.value?alert(c.error.empty):a.Joomla("submitform",["demoteMembers"])}}}),b.resolve()}),EasySocial.module("admin/discovery/discovery",function(){var b=this;EasySocial.require().script("admin/progress/progress").done(function(a){EasySocial.Controller("Admin.Discovery",{defaultOptions:{files:[],namespace:"",progressController:null,"{progress}":"[data-progress]","{result}":"[data-discovery-result]"}},function(b,c){return{init:function(){c.progressController=b.progress().addController(EasySocial.Controller.Progress),a.Joomla("submitbutton",function(a){"discover"==a&&b.start()
...
}})},this.each(function(){if(a.support.selectOpacity){var b=a(this);b.is("select")?1!=b.attr("multiple")&&(void 0==b.attr("size")||b.attr("size")<=1)&&g(b):b.is(":checkbox")?h(b):b.is(":radio")?i(b):b.is(":file")?j(b):b.is(":text, :password, input[type='email']")?d(b):b.is("textarea")?e(b):(b.is("a")||b.is(":submit")||b.is(":reset")||b.is("button")||b.is("input[type=button]"))&&f(b)}})}}(a),b.resolve()}),EasySocial.module("admin/workflows/form",function(){var b=this;EasySocial.require().library("ui/sortable","scrollTo").done(function(a){EasySocial.Controller("Workflows",{defaultOptions:{id:null,tmpSteps:null,tpls:{},fieldsValue:{},fieldsData:{},fieldsChoices:{},fieldsConditions:{},stepsValue:{},stepsHtml:{},fieldsConfigValue:{},deletedFields:{},deletedSteps:{},hiddenClass:"t-hidden","{templates}":"[data-workflow-templates]","{content}":"[data-content]","{titleInput}":"[data-input-workflow-title]","{descInput}":"[data-input-workflow-description]","{workflowConfigSave}":"[data-workflow-config-save-button]","{steps}":"[data-steps]","{step}":"[data-step-item]","{newStep}":"[data-step-new]","{stepTitle}":"[data-step-title]","{editStep}":"[data-step-edit]","{deleteStep}":"[data-step-delete]","{fields}":"[data-fields]","{field}":"[data-field-item]","{newField}":"[data-field-new]","{moveField}":"[data-field-item-move]","{deleteField}":"[data-field-item-delete]","{editField}":"[data-field-item-edit]","{conditionalField}":"[data-field-item-conditional]","{conditionalParam}":"[data-fields-conditional-param]","{fieldRequiredSymbol}":"[data-field-item-required]","{saveFieldsInput}":"[data-fields-saved-value]","{fieldSettings}":"[data-field-settings]","{fieldParam}":"[data-fields-config-param]","{fieldBrowser}":"[data-field-browser]","{fieldBrowserClose}":"[data-field-browser-close]","{fieldsTypeTab}":"[data-field-type-tab]","{fieldTypeContent}":"[data-field-type-content]","{fieldBrowserItems}":"[data-field-browser-items]","{fieldBrowserItem}":"[data-field-browser-item]","{dialogFieldSave}":"[data-field-save-button]","{dialogFieldCancel}":"[data-field-cancel-button]","{dialogFieldTab}":"[data-field-tab]","{dialogFieldContent}":"[data-field-content]","{dialogStepSave}":"[data-field-step-save-button]","{dialogError}":"[data-dialog-error]","{dialogErrorClose}":"[data-dialog-error-close]"}},function(b,c){return{init:function(){c.id=b.element.data("id"),this.initTemplates(),this.initSortable(),this.initDefaultData()
},initDefaultData:function(){if(!c.id||""==c.id){var d=JSON.parse(c.tmpSteps);a.each(d,function(c,d){var e=[{name:"title",value:d.title},{name:"description",value:d.description}];b.storeSteps(d.id,e),d.fields&&a.each(d.fields,function(c,d){var e=[];a.each(d,function(a,b){var c={name:a,value:b};e.push(c)}),b.storeFieldsData(d.id,e)})})}},initTemplates:function(){var d=b.templates().children();a.each(d,function(){var b=a(this),d=b.data("template");c.tpls[d]=b.html()})},initSortable:function(){this.initStepsSortable(),this.initFieldsSortable()
},initStepsSortable:function(){b.steps().sortable({items:b.step.selector,cursor:"move",forceHelperSize:!0,axis:"x",update:function(){b.updateOrdering(b.step())}})},initFieldsSortable:function(){b.fields().sortable({items:b.field.selector,cursor:"move",forceHelperSize:!0,axis:"y",start:function(a,b){b.helper.addClass("is-new"),b.helper.hasClass("has-condition")&&b.helper.removeClass("has-condition").addClass("has-condition-tmp")},stop:function(a,b){setTimeout(function(){b.item.removeClass("is-new"),b.item.hasClass("has-condition-tmp")&&b.item.removeClass("has-condition-tmp").addClass("has-condition")
},150)},update:function(){b.updateOrdering(b.field())}})},getTemplate:function(b){var d=a(c.tpls[b]).clone();return d},updateOrdering:function(b){a.each(b,function(){var b=a(this),c=b.index();b.attr("data-ordering",c)})},changed:!1,isChanged:function(){b.changed=!0},save:function(){var d=a.Deferred();if(!b.fieldsTypeTab().filter('[id="core"]').hasClass(c.hiddenClass)){var e=a(b.getTemplate("dialog-error"));return b.fieldSettings().html(e.wrap("<p/>").parent().html()),e.unwrap(),d.reject(),d}var f=b.fetchWorkflowData();
return b.injectSaveData(f),d.resolve(),d},getAvailableFields:function(){return b.fetchWorkflowData(!1,!0)},fetchWorkflowData:function(d,e){var f=[],g=0,h=b.step();d&&(h=b.getCurrentStep()),a.each(h,function(d,h){var h=a(h),i=a(b.content.selector+'[data-id="'+h.data("id")+'"]'),j=[],k=[],l=i.find(b.field.selector);if(l.length>0){var m=0;if(a.each(l,function(b,d){var d=a(d);if(e)var f={fieldTitle:d.find("[data-field-item-title]").html(),fieldId:d.data("id"),fieldElement:d.data("element"),appId:d.data("appid")};
...
return j},openWorkflowConfig:function(){var c=a(b.getTemplate("workflow-config"));c.find("[data-workflow-config-title]").val(b.titleInput().val()),c.find("[data-workflow-config-description]").val(b.descInput().val()),b.fieldSettings().html(c.wrap("<p/>").parent().html()),c.unwrap()},"{workflowConfigSave} click":function(c){var e=c.parents("[data-config-dialog]"),f=e.find("[data-workflow-config-title]").val(),g=e.find("[data-workflow-config-description]").val();b.titleInput().val(f),b.descInput().val(g),a("[data-structure-heading]").html(f),a("[data-structure-description]").html(g),b.dialogFieldCancel().trigger("click")
},"{newStep} click":function(){b.addStep()},"{step} click":function(a){var d=a.data("id");b.switchTab(d)},showFieldBrowser:function(){b.fieldBrowser().removeClass(c.hiddenClass)},hideFieldBrowser:function(){b.fieldBrowser().addClass(c.hiddenClass)},showDialogError:function(){b.dialogError().removeClass(c.hiddenClass)},hideDialogError:function(){b.dialogError().addClass(c.hiddenClass)},getNewFieldButton:function(){var b=a("[data-field-new]").first().clone();return b},getField:function(c){var d=a(b.field.selector+'[data-id="'+c+'"]');
return d},updateFieldBrowser:function(a,d){var f=b.fieldBrowserItem().filter('[data-id="'+a+'"]'),g=f.parents(b.fieldTypeContent.selector);if("standard"!=g.attr("id")){f[d+"Class"](c.hiddenClass);var h=g.find(b.fieldBrowserItems.selector).children(),i=b.fieldsTypeTab().filter('[id="'+g.attr("id")+'"]');h.not("."+c.hiddenClass).length<1?(i.addClass(c.hiddenClass),b.fieldsTypeTab().not("."+c.hiddenClass).eq(0).trigger("click")):i.removeClass(c.hiddenClass)}},switchTab:function(a){var d=b.getStepTab(a),e=b.getStepContent(a);
b.step().removeClass("is-active"),d.addClass("is-active"),b.content().addClass(c.hiddenClass),e.removeClass(c.hiddenClass)},addStep:function(){var d=a.uid(),e=b.getTemplate("step");e.attr("data-id",d),e.insertBefore(b.newStep());var f=b.getTemplate("editor");f.attr("data-id",d),f.insertBefore(b.templates()),b.updateOrdering(b.step()),b.deleteStep().removeClass(c.hiddenClass),e.trigger("click")},addField:function(c,d,e){var f=!1;if(void 0==d){var d=b.getTemplate("field"),g=c.data("fieldElement");"header"==g&&d.addClass("es-wf-field--header"),d.attr("data-id",a.uid()),d.attr("data-appid",c.data("id")),d.attr("data-element",g),d.find("[data-field-item-title]").html(c.data("fieldTitle")),d.find("[data-field-item-element]").html(g.toUpperCase()),f=!0
}if(void 0==e)var e=b.getCurrentStep();var h=e.find("[data-fields-wrapper]"),i=h.find("[data-fields]");if(i.children().length>0){var j=i.find(b.currentNewField),k=j.data("action");j[k](d)}else i.append(b.getNewFieldButton().attr("data-action","after")),i.append(d),i.append(b.getNewFieldButton().attr("data-action","before"));h.removeClass("is-empty"),b.updateOrdering(i.children()),b.initFieldsSortable(),f&&(b.hideFieldBrowser(),b.updateFieldBrowser(c.data("id"),"add")),a.scrollTo(d.offset().top-250,200),d.addClass("is-new"),setTimeout(function(){d.removeClass("is-new")
},1500)},"{fieldBrowserItem} click":function(a){b.addField(a)},"{fieldBrowser} click":function(a,c){c.target==a[0]&&(c.preventDefault(),c.stopPropagation(),b.hideFieldBrowser())},"{dialogError} click":function(a,c){c.target==a[0]&&(c.preventDefault(),c.stopPropagation(),b.hideDialogError())},"{dialogErrorClose} click":function(a,c){c.preventDefault(),c.stopPropagation(),b.hideDialogError()},"{newField} click":function(a){b.currentNewField=a,b.showFieldBrowser()},"{fieldBrowserClose} click":function(){b.hideFieldBrowser()
...
},storeFieldsData:function(a,b){c.fieldsValue[a]=b},storeStepsData:function(a,b){c.stepsValue[a]=b},getCurrentStep:function(){return b.content().not("."+c.hiddenClass)},getStepTab:function(c){return a(b.step.selector+'[data-id="'+c+'"]')},getStepContent:function(b){return a("[data-content][data-id="+b+"]")},injectSaveData:function(a){b.saveFieldsInput().val(""),a&&(a=JSON.stringify(a),b.saveFieldsInput().val(a))},updateFieldTitle:function(a,c){if(c){var d=b.getField(a);d.find("[data-field-item-title]").html(c)
}},updateFieldRequired:function(a,d){var e=b.getField(a),f=e.find(b.fieldRequiredSymbol.selector);e.attr("data-required",d),"1"==d?f.removeClass(c.hiddenClass):f.addClass(c.hiddenClass)},updateConditionsUI:function(d,e){var f=a(b.field.selector+'[data-id="'+d+'"]');return e&&void 0!=e?(f.find("[data-field-item-conditional]").removeClass(c.hiddenClass),f.addClass("has-condition"),void 0):(f.find("[data-field-item-conditional]").addClass(c.hiddenClass),f.removeClass("has-condition"),void 0)},updateStepHeader:function(c,d,e){if(d||e){var f=a(b.step.selector+'[data-id="'+c+'"]'),g=a(b.content.selector+'[data-id="'+c+'"]');
...
}),b.storeFields(g,i,l),b.updateFieldTitle(g,m),b.updateFieldRequired(g,o),b.updateConditionsUI(g,j),b.dialogFieldCancel().trigger("click"),b.isChanged()},"{dialogFieldTab} click":function(a){var e=a.data("id");b.dialogFieldTab().removeClass("active"),a.addClass("active"),b.dialogFieldContent().addClass(c.hiddenClass),b.dialogFieldContent().filter('[data-id="'+e+'"]').removeClass(c.hiddenClass)},"{deleteStep} click":function(d){var f=b.getTemplate("dialog-delete-step");b.fieldSettings().html(f.wrap("<p/>").parent().html()),f.unwrap();
var g=b.fieldSettings().find("[data-dialog-confirm]");g.on("click",function(){var f=d.parents(b.content.selector),g=f.data("id"),h=a(b.step.selector+"[data-id="+g+"]");if(h.prev().length>0)var i=h.prev();else var i=h.next();a.each(f.find(b.field.selector),function(c,d){b.updateFieldBrowser(a(d).data("appid"),"remove")}),void 0===b.deletedSteps&&(b.deletedSteps=[]),h.data("isnew")===!1&&b.deletedSteps.push(g),f.remove(),h.remove(),b.steps().children(b.step.selector).length<2&&b.deleteStep().addClass(c.hiddenClass),delete c.stepsValue[g],i.trigger("click"),b.isChanged(),b.dialogFieldCancel().trigger("click")
})},"{editField} click":function(d){var f=d.parents(b.field.selector),g=f.data("appid"),h=f.data("id"),i=c.fieldsValue[h],j=b.getAvailableFields(),k=[];b.fieldsData=[],b.fieldsConditions=[],b.fieldsChoices=[],b.fieldSettings().html(b.getTemplate("dialog-loader")),EasySocial.ajax("admin/views/fields/loadFieldConfiguration",{appId:g,fieldId:h,previousData:i,availableFields:j}).done(function(c,d,e){a.each(e,function(b,c){a.each(c.fields,function(b,c){c.subfields?a.each(c.subfields,function(a,c){k[b+"_"+a]=c}):k[b]=c
