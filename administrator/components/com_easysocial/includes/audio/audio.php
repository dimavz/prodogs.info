...
class SocialAudio extends EasySocial
{
	...
	public function insertPrivacy($privacy)
	{
		...
		$privacyLib->add($privacy->rule, $this->table->id, SOCIAL_TYPE_AUDIOS, $privacy->value, null, $privacy->custom);
	}
	...
	public function insertAlbumArt($data, $isNew = true)
	{
		...
		$tmpPath = dirname($albumartObj->stock->path);
	...
	public function getUploadEmbedCodes()
	{
		...
		$output = $theme->output('site/audios/player/default');
	...
	public function delete()
	{
		...
		$likes = ES::likes();
		$likes->delete($this->id, SOCIAL_TYPE_AUDIOS, 'create');
