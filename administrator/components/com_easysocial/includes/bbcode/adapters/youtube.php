...
class SocialBBCodeYoutube
{
	...
	public function getEmbedHTML($url)
	{
		...
		if ($code) {
			return '<div class="es-video es-video--16by9"><iframe title="YouTube video player" width="720" height="405" src="//www.youtube.com/embed/' . $code . '?wmode=transparent" frameborder="0" allowfullscreen></iframe></div>';
		} else {
