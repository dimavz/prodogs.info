...
?>
<div id="es" class="es-dialog has-footer es-dialog--workflow type-html active t-hidden<?php echo $installedFields ? '' : ' no-tabs'; ?>" data-field-browser>
		...
		<div class="es-dialog-footer">
			<div>
				<div class="es-dialog-footer-content">
					<button data-field-browser-close type="button" class="btn btn-es-primary-o btn-sm"><?php echo JText::_('COM_EASYSOCIAL_CLOSE'); ?></button>
				</div>
			</div>
		</div>
	</div>
