...
?>
<div id="es" class="mod-es-profile-completeness <?php echo $suffix;?>">
	
	<div class="mod-es-title"><?php echo JText::sprintf('MOD_EASYSOCIAL_PROFILE_COMPLETENESS_PERCENTAGE', $percentage); ?></div>

	<div class="progress ">
	  <div class="progress-bar progress-bar-success" role="progressbar" style="width: <?php echo $percentage; ?>%;">
	  </div>
	</div>
