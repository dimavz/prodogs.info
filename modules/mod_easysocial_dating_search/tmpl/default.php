...
?>
<div id="es" class="mod-es mod-es-dating-search <?php echo $lib->getSuffix();?>" data-mod-dating-search>
<form method="get" action="<?php echo JRoute::_('index.php'); ?>" name="frmSearch" class="mod-es-dating-search-form <?php echo $lib->isMobile() ? 'is-mobile' : '';?>">
	...
	<div data-mod-dating-search-item class="o-form-group">
		...
		<div class="o-radio">
			<input type="radio" id="item-radio-gender1" name="search-gender" value="1" <?php echo ($fieldGender->data == "1") ? 'checked="checked"' : ''; ?> data-gender-radio />
			<label for="item-radio-gender1">
				<?php echo JText::_('MOD_EASYSOCIAL_DATING_SEARCH_GENDER_MALE'); ?>
			</label>
		</div>

		<div class="o-radio">
			<input type="radio" id="item-radio-gender2" name="search-gender" value="2" <?php echo ($fieldGender->data == "2") ? 'checked="checked"' : ''; ?> data-gender-radio />
			<label for="item-radio-gender2">
				<?php echo JText::_('MOD_EASYSOCIAL_DATING_SEARCH_GENDER_FEMALE'); ?>
			</label>
		</div>

		<?php if ($fieldGender->custom) { ?>
		<div class="o-radio">
			<input type="radio" id="item-radio-gender3" name="search-gender" value="3" <?php echo ($fieldGender->data == "3") ? 'checked="checked"' : ''; ?> data-gender-radio />
			<label for="item-radio-gender3">
				<?php echo JText::_('MOD_EASYSOCIAL_DATING_SEARCH_GENDER_OTHERS'); ?>
			</label>
		</div>
		<?php } ?>
		...
		<div data-location-label class="o-input-group">
			...
			<span class="o-input-group__btn">
				<button class="btn btn-es-default" type="button" data-location-detect>
					...
					<i class="fa fa-map-marker" data-loaction-icon></i>
				</button>
			</span>
		</div>
